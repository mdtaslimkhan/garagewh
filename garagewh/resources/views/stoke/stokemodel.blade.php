					...
					<tr>
						<td width="70%">
							...
							<span style="float:left;">
								...
								<img src="../vehicle/service.png" style="width: 245px; height: 90px;">
								
								<img src="../general_setting/<?php echo $logo->logo_image ?>" width="230px" height="70px" style="position: absolute; top: 120px; left: 25px;">
