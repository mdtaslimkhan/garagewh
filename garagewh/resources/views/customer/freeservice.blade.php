		...
		<div class="row">
			<div class="col-md-7 col-sm-7 col-xs-12">	
				...
				<div class="col-md-6 col-sm-12 col-xs-12 printimg">
						...
						<img src="../../vehicle/service.png" style="width: 243px; height: 90px;">
								
						<img src="../..//general_setting/<?php echo $logo->logo_image ?>" width="230px" height="70px" style="position: absolute; top: 10px; left: 25px;">
