...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ URL::asset('css/responsive_styles.css') }}">

	<!-- MoT Custom stylesheet -->
	<link rel="stylesheet" type="text/css" href=" {{ URL::asset('css/custom_mot_styles.css') }} ">
   <!-- Datatables -->
	...
	<link rel="stylesheet" type="text/css" href="{{ URL::asset('css/google_api_font.css') }}">
	@if(getValue()=='rtl')
              ...
              <div class="profile_pic">
				 @if(!empty(Auth::user()->id))
					 @if(Auth::user()->role=='admin')
						  <a href="{!! url('/setting/profile')!!}"><img src="{{ URL::asset('admin/'.Auth::user()->image)}}" alt="..." class="img-circle profile_img"></a>
					@endif
					 @if(Auth::user()->role=='Customer')
						 <a href="{!! url('/setting/profile')!!}"><img src="{{ URL::asset('customer/'.Auth::user()->image)}}" alt="..." class="img-circle profile_img"></a>
					@endif
					
					@if(Auth::user()->role=='Supplier')
						 <a href="{!! url('/setting/profile')!!}"><img src="{{ URL::asset('supplier/'.Auth::user()->image)}}" alt="..." class="img-circle profile_img"></a>
					@endif
					
					@if(Auth::user()->role=='employee')
						 <a href="{!! url('/setting/profile')!!}"><img src="{{ URL::asset('employee/'.Auth::user()->image)}}" alt="..." class="img-circle profile_img"></a>
					@endif
					
					 @if(Auth::user()->role=='accountant')
						 <a href="{!! url('/setting/profile')!!}"><img src="{{ URL::asset('accountant/'.Auth::user()->image)}}" alt="..." class="img-circle profile_img"></a>
					@endif
					
					@if(Auth::user()->role=='supportstaff')
						 <a href="{!! url('/setting/profile')!!}"><img src="{{ URL::asset('supportstaff/'.Auth::user()->image)}}" alt="..." class="img-circle profile_img"></a>
					@endif
				@endif
              </div>
