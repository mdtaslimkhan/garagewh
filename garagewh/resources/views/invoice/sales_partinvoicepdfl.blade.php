						...
						<tr>
							<td  width="15%" style="vertical-align:top;float:left; width:15%;" align="left" >
								 <span style="float:left; width:100%;">
									<img src="../vehicle/service.png" style="width: 230px; height: 90px;">
									<img src="../general_setting/<?php echo $logo->logo_image ?>" width="230px" height="70px" style="position: absolute; top: 123px; left: 37px;">
								</span>
							</td>
