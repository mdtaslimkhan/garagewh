						...
						<form id="profileEditForm"  action="profile/update/{{ $profile->id }}" method="post" enctype="multipart/form-data" class="form-horizontal upperform">
							...
							<div class="form-group col-md-12 col-sm-12 col-xs-12 has-feedback {{ $errors->has('image') ? 'has-error' : '' }} my-form-group">
								...
								@if($profile->role == "admin")
									<img src="{{ url('admin/'.$profile->image) }}"  width="50px" height="50px" class="img-circle" >
								@elseif($profile->role == "Customer")
									<img src="{{ url('customer/'.$profile->image) }}"  width="50px" height="50px" class="img-circle" >
								@elseif($profile->role == "employee")
									<img src="{{ url('employee/'.$profile->image) }}"  width="50px" height="50px" class="img-circle" >
								@elseif($profile->role == "supportstaff")
									<img src="{{ url('supportstaff/'.$profile->image) }}"  width="50px" height="50px" class="img-circle" >
								@elseif($profile->role == "accountant")
									<img src="{{ url('accountant/'.$profile->image) }}"  width="50px" height="50px" class="img-circle" >
								@endif
								    @if ($errors->has('image'))
								   <span class="help-block">
