							...
							<div class="my-form-group">
								...
								<div class="col-md-4 col-sm-4 col-xs-12">
									<input type="file" id="input-file-max-fs"  name="image"  class="form-control dropify" data-max-file-size="5M" >
									 ...
									 <img src="{{ URL::asset('product/'.$product->product_image) }}"  width="60px" height="60px" class="img-circle" style="margin-top:10px;">
									 @else
										 <img src="{{ URL::asset('product/avtar.png') }}"  width="60px" height="60px" class="img-circle" style="margin-top:10px;">
									 @endif
