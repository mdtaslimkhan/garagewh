			...
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-12">
						<span style="float:left;" class="printimg">
							<img src="../vehicle/service.png" style="width: 240px; height: 90px;">
							<img src="../general_setting/<?php echo $setting->logo_image ?>" width="230px" height="70px" style="position: absolute; top: 10px; left: 15px;">
						</span>
				</div>
