...
<link type="text/css" href="{{ URL::asset('/css/dashboard_page_all_part_styles.css') }}" rel="stylesheet" >

<!-- CSS For Chart -->
<link rel="stylesheet" type="text/css" href="{{ URL::asset('/js/49/css/tooltip.css') }}">
<link rel="stylesheet" type="text/css" href="{{ URL::asset('/js/49/css/util.css') }}">
...
<!-- <script src="{{ URL::asset('build/js/Chart.min.js') }}" defer="defer"></script> -->
	...
	<!--  Free service customer view -->
				...
				<nav>
					<div class="nav toggle">
						<a id="menu_toggle"><i class="fa fa-bars" style="color:#fff;"></i></a>
							<span class="titleup"> <a href="{!! url('/')!!}"> <img src="{{ URL::asset('general_setting/'.getLogoSystem())}}" width="140px" height="45px" style="background-color: #2a3f54;" ></a>
							<!-- ( {{ trans('app.Dashboard')}} ) -->
							</span>
						...
						<li class="">
							...
							@if(!empty(Auth::user()->id))
								@if(Auth::user()->role=='admin')
									<img src="{{ URL::asset('/admin/'.Auth::user()->image)}}" alt="admin"  width="40px" height="40px" class="img-circle">
								@endif
								@if(Auth::user()->role=='Customer')
									<img src="{{ URL::asset('/customer/'.Auth::user()->image)}}" alt="customer" width="40px" height="40px" class="img-circle">
								@endif
							
								@if(Auth::user()->role=='Supplier')
									<img src="{{ URL::asset('/supplier/'.Auth::user()->image)}}" alt="supplier" width="40px" height="40px" class="img-circle">
								@endif
							
								@if(Auth::user()->role=='employee')
									<img src="{{ URL::asset('/employee/'.Auth::user()->image)}}" alt="employee" width="40px" height="40px" class="img-circle">
								@endif
								
								@if(Auth::user()->role=='accountant')
									<img src="{{ URL::asset('/accountant/'.Auth::user()->image)}}" alt="accountant" width="40px" height="40px" class="img-circle">
								@endif
							
								@if(Auth::user()->role=='supportstaff')
									<img src="{{ URL::asset('/supportstaff/'.Auth::user()->image)}}" alt="supportstaff" width="40px" height="40px" class="img-circle">
								@endif
        	...
        	<div class="col-lg-1 col-md-1 col-xs-6 col-sm-2 ">
				<a href="employee/list" target="blank">
					<div class="panel info-box panel-white">
						...
						<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Customer-Green.png')}}" class="dashboard_background" alt="" height="20px" width="20px">	
			...
			<div class="col-lg-1 col-md-1 col-xs-6 col-sm-2 ">
				<a href="employee/list" target="blank">
					<div class="panel info-box circless">
						...
						<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Customer-Green.png')}}" class="dashboard_background img1" alt="" height="20px" width="20px">	
							 <div class="info-box-stats info-box-statss">
							 	<p class="info-box-title">{{ trans('app.Employees')}}</p>
								<span class="info-box-title">{{ trans('app.Employees name')}}</span>
							</div>
        ...
        <div class="row mainRowDiv" style="">
        	@if($Customer != 0)
	       	<div class="steps step step-one greenCircle step-oneGreen"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Customer-Green.png')}}" alt="Avatar" class="main-image">
				<span class="name-text_green">{{ trans('app.Customer')}}</span>
				<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
			</div>
			@else
			<div class="steps step step-one blueCircle step-oneBlue"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Customer-Blue.png')}}" alt="Avatar" class="main-image">
				<span class="name-text_blue">{{ trans('app.Customer')}}</span>
				<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/3-dot.png')}}" alt="Avatar" class="imgs">
			</div>
			@endif

			@if($employee != 0)
			<div class="steps step step-two greenCircle step-twoGreen"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Employee-Green.png')}}" alt="Avatar" class="main-image">
				<span class="name-text_green">{{ trans('app.Employee')}}</span>
				<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
			</div>
			@else
			<div class="steps step step-two blueCircle step-twoBlue"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Employee-Blue.png')}}" alt="Avatar" class="main-image">
			...
			<div class="steps step step-three greenCircle step-threeGreen"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Support-Staff-Green.png')}}" alt="Avatar" class="main-image">
				<span class="name-text_green">{{ trans('app.Support Staff')}}</span>
				<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
			</div>
			@else
			<div class="steps step step-three blueCircle step-threeBlue"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Support-Staff-Blue.png')}}" alt="Avatar" class="main-image">
			...
			@if($Supplier != 0)
			<div class="steps step step-four greenCircle step-fourGreen"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Supplier-Green.png')}}" alt="Avatar" class="main-image">
				<span class="name-text_green">{{ trans('app.Supplier')}}</span>
				<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
			</div>
			@else
			<div class="steps step step-four blueCircle step-fourBlue"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Supplier-Blue.png')}}" alt="Avatar" class="main-image">
			...
			@if($have_vehicle != 0)
			<div class="steps step step-five greenCircle step-fiveGreen"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Vehicle-Green.png')}}" alt="Avatar" class="main-image">
				<span class="name-text_green">{{ trans('app.Vehicles')}}</span>
				<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
			</div>
			@else
			<div class="steps step step-five blueCircle step-fiveBlue"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Vehicle-Blue.png')}}" alt="Avatar" class="main-image">
			...
			@if($have_product != 0)
			<div class="steps step step-six greenCircle step-sixGreen"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Product-Green.png')}}" alt="Avatar" class="main-image">
				<span class="name-text_green">{{ trans('app.Products')}}</span>
				<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
			</div>
			@else
			<div class="steps step step-six blueCircle step-sixBlue"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Product-Blue.png')}}" alt="Avatar" class="main-image">
			...
			@if($have_purchase != 0)
			<div class="steps step step-seven greenCircle step-sevenGreen"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Purchase-Green.png')}}" alt="Avatar" class="main-image">
				<span class="name-text_green">{{ trans('app.Purchase')}}</span>
				<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
			</div>
			@else
			<div class="steps step step-seven blueCircle step-sevenBlue"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Purchase-Blue.png')}}" alt="Avatar" class="main-image">
			...
			<div class="steps step step-eight greenCircle step-eightGreen"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Observation-Green.png')}}" alt="Avatar" class="main-image">
				<span class="name-text_green">{{ trans('app.Observation Library')}}</span>
				<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
			</div>
			@else
			<div class="steps step step-eight blueCircle step-eightBlue"><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Observation-Blue.png')}}" alt="Avatar" class="main-image">
		...
		<div class="row wizard_image_main_class" style="display: none;">
			@if($Customer != 0)
				<li class="wizard_image_green">					
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Customer-Green.png')}}" class="green_img"  alt="">					
					<span class="marker-text_green">{{ trans('app.Customer')}}</span>
					<span class="span_img_green" style=""><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" class="green"  alt=""></span>
				</li>
			@else
				<li class="wizard_image_blue">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Customer-Blue.png')}}" class="blue_img" alt="">
					<span class="marker-text_blue">{{ trans('app.Customer')}}</span>
					<span class="span_img_blue" style=""><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/3-dot.png')}}" class=""  alt=""></span>	
				</li>
			@endif

			@if($employee != 0)
				<li class="wizard_image_green">					
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Employee-Green.png')}}" class="green_img" alt="">
					<span class="marker-text_green">{{ trans('app.Employee')}}</span>
					<span class="span_img_green" style=""><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" class="green"  alt=""></span>
				</li>
			@else
				<li class="wizard_image_blue">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Employee-Blue.png')}}" class="blue_img" alt="">
			...
			@if($have_supportstaff != 0)
				<li class="wizard_image_green">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Support-Staff-Green.png')}}" class="green_img" alt="">
					<span class="marker-text_green">{{ trans('app.Supportstaff')}}</span>
					<span class="span_img_green" style=""><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" class="green"  alt=""></span>
				</li>
			@else
				<li class="wizard_image_blue">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Support-Staff-Blue.png')}}" class="blue_img" alt="">
			...
			@if($Supplier != 0)
				<li class="wizard_image_green">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Supplier-Green.png')}}" class="green_img" alt="">
					<span class="marker-text_green">{{ trans('app.Supplier')}}</span>
					<span class="span_img_green" style=""><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" class="green"  alt=""></span>
				</li>
			@else
				<li class="wizard_image_blue">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Supplier-Blue.png')}}" class="blue_img" alt="">
			...
			@if($have_vehicle != 0)
				<li class="wizard_image_green">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Vehicle-Green.png')}}" class="green_img" alt="">
					<span class="marker-text_green">{{ trans('app.Vehicles')}}</span>
					<span class="span_img_green" style=""><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" class="green"  alt=""></span>
				</li>
			@else
				<li class="wizard_image_blue">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Vehicle-Blue.png')}}" class="blue_img" alt="">
			...
			@if($have_product != 0)
				<li class="wizard_image_green">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Product-Green.png')}}" class="green_img" alt="">
					<span class="marker-text_green">{{ trans('app.Products')}}</span>
					<span class="span_img_green" style=""><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" class="green"  alt=""></span>
				</li>
			@else
				<li class="wizard_image_blue">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Product-Blue.png')}}" class="blue_img" alt="">
			...
			@if($have_purchase != 0)
				<li class="wizard_image_green">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Purchase-Green.png')}}" class="green_img" alt="">
					<span class="marker-text_green">{{ trans('app.Purchase')}}</span>
					<span class="span_img_green" style=""><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" class="green"  alt=""></span>
				</li>
			@else
				<li class="wizard_image_blue">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Purchase-Blue.png')}}" class="blue_img" alt="">
			...
			@if($have_observationCount != 0)
				<li class="wizard_image_green">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Observation-Green.png')}}" class="green_img" alt="">
					<span class="marker-text_green">{{ trans('app.Observation')}}</span>
					<span class="span_img_green" style=""><img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Check.png')}}" class="green"  alt=""></span>
				</li>
			@else
				<li class="wizard_image_blue">
					<img src="{{ URL::asset('/img/dashboard/wizard_setup_image/Observation-Blue.png')}}" class="blue_img" alt="">
		...
		<div class="row calculationBoxes">
			<div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 ">
				<a href="employee/list" target="blank">
					<div class="panel info-box panel-white">
						...
						<img src="{{ URL::asset('/img/dashboard/team.png')}}" class="dashboard_background" alt="">	
			...
			<div class="col-lg-2 col-md-2 col-xs-6 col-sm-3">
				<a href="customer/list" target="blank">
					<div class="panel info-box panel-white">
						...
						<img src="{{ URL::asset('/img/dashboard/client.png')}}" class="dashboard_background" alt="">	
							<div class="info-box-stats">
								<p class="counter">
			...
			<div class="col-lg-2 col-md-2 col-xs-6 col-sm-3">
				<a href="supplier/list" target="blank">
					<div class="panel info-box panel-white">
						...
						<img src="{{ URL::asset('/img/dashboard/telemarketer.png')}}" class="dashboard_background" alt="">						<div class="info-box-stats">
								<p class="counter">
									@if(isset($Supplier))
									<?php echo $Supplier; ?>
								@else
			...
			<div class="col-lg-2 col-md-2 col-xs-6 col-sm-3">
				<a href="product/list" target="blank">
					<div class="panel info-box panel-white">
						...
						<img src="{{ URL::asset('/img/dashboard/industrial-robot.png')}}" class="dashboard_background" alt="">	
							<div class="info-box-stats">
								<p class="counter">
								  @if($product)
									<?php echo $product; ?>
			...
			<div class="col-lg-2 col-md-2 col-xs-6 col-sm-3">
				<a href="sales/list" target="blank">
					<div class="panel info-box panel-white">
						<div class="panel-body member">
						<img src="{{ URL::asset('/img/dashboard/contract.png')}}" class="dashboard_background" alt="">						<div class="info-box-stats">
								<p class="counter">
								@if($sales)
								 <?php echo $sales; ?>
							 @else
			...
			<div class="col-lg-2 col-md-2 col-xs-6 col-sm-3">
				<a  href="service/list" target="blank">
					<div class="panel info-box panel-white">
						<div class="panel-body staff-member">
						<img src="{{ URL::asset('/img/dashboard/tasks.png')}}" class="dashboard_background" alt="">						<div class="info-box-stats">
								<p class="counter">
								@if($service)
									<?php echo $service; ?>
								@else
					...
					<div class="x_panel rjc"> 
						...
						@foreach($Customere as $user)
						  <li class="media event">
							<a class="userpic">
							 <img src="{{ URL::asset('/customer/'.$user->image) }}" style="width: 40px; height: 40px;margin-right: 18px;" class="img-circle" > 
							</a>
							<div class="media-body">
...
<script type="text/javascript" src="{{ URL::asset('/js/loader.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('/js/49/loader.js') }}" defer="defer"></script>
<script type="text/javascript" src="{{ URL::asset('/js/49/jsapi_compiled_default_module.js') }}" defer="defer"></script>
<script type="text/javascript" src="{{ URL::asset('/js/49/jsapi_compiled_graphics_module.js') }}" defer="defer"></script>
<script type="text/javascript" src="{{ URL::asset('/js/49/jsapi_compiled_ui_module.js') }}" defer="defer"></script>
<script type="text/javascript" src="{{ URL::asset('/js/49/jsapi_compiled_corechart_module.js') }}" defer="defer"></script>
...
<!--  Free service -->
<!-- <script src="{{ URL::asset('/js/Dashboard/Free_service.js') }}" ></script> -->
<script type="text/javascript">
	$(document).ready(function(){
...
<!-- Paid service -->
<!-- <script src="{{ URL::asset('/js/Dashboard/Paid_service.js') }}" ></script> -->
<script type="text/javascript">
	$(document).ready(function(){
...
<!-- Repeat Job service  -->
<!-- <script src="{{ URL::asset('/js/Dashboard/Repeat_Job_service.js') }}" ></script> -->
<script type="text/javascript">
	$(document).ready(function(){
...
<!-- <script src="{{ URL::asset('/js/Dashboard/Free_customer_model_service.js') }}" ></script> -->
<script type="text/javascript">
	$(document).ready(function(){
